                ...
                $present="Present";
                     ...
                     $result = $stmt->get_result();
                      ...
                      <td  style="width:20%">
                       ...
                       <p><a href="update-advance.php?id=<?php echo $row['emp_id'];?>" data-placement="top" data-toggle="tooltip" title="Edit"><button type="button" class="btn btn-success" data-title="Edit"><i class="fas fa-edit"></i></button></a>  </p>            
