...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    for ($i = 0; $i < count($name_array); $i++) {
       ...
       //foreach($att_array  as $key=>$i ) { 
        ...
        $stmt = $db->prepare("INSERT INTO salary(emp_id,emp_name,salary_perday,work_hour,date) VALUES(?,?,?,?,?)"); //Fetching all the records with input credentials
