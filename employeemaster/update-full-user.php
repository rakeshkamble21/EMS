    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <?php
                    ...
                    try
                    {
                        $sql = "SELECT * FROM full_time_emp where emp_id=?";
                        $stmt = $db->prepare($sql); 
                ...
                <div class="form-content">
                    ...
                    <a href="view-full-time-employee.php"><button type="button" class="btn btn-danger">Back</button></a>
                </div>
                <?php
                ...
                else  if(!preg_match("/^(\+\d{1,3}[- ]?)?\d{10}$/", $mobile))
                {
                 ...
                 else
                 {
                   // echo $first."".$last."".$mobile."".$address."".$salary."".$gender."".$ids;
                    $stmt = $db->prepare("update full_time_emp set firstname=?,lastname=?,mobile=?,address=?,salary=?,gender=? where emp_id=?"); //Fetching all the records with input credentials
