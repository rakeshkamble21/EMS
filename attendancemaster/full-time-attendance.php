...
<div class="col-md-10">
<h3 style="text-align:center;margin-top:20px">Enter 12 hours Employee Attendance</h3>
...
<table class="table table-bordered" style="margin-top:20px" id="attendance">
    ...
    <a href="save-full-time-attendance.php"><input type="button" class="btn btn-primary" name="button" value="Save Attendance" /></a>
    <a href="../home.php"><input type="button" class="btn btn-danger" name="button" value="Back" /></a>
    <a href="view-full-time-attendance.php"><input type="button" class="btn btn-info" name="button" value="View Attendance" /></a>
</form>
</div>
</div>
</div>
...
if(empty($time))
{
    ...
    for ($i = 0; $i < count($name_array); $i++) {
       ...
       //foreach($att_array  as $key=>$i ) { 
        ...
        echo $new_date;
        $attendance= $db->prepare("INSERT INTO full_time_attendance(emp_id,emp_name,attendance,in_time,out_time,date) VALUES(?,?,?,?,?,?)");
